...
def downgrade() -> None:
    ...
    sa.Column('downloaded_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.Column('ip_address', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('user_agent', sa.TEXT(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['segment_id'], ['segments.id'], name='download_logs_segment_id_fkey'),
    ...
    sa.Column('start_ts', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.Column('end_ts', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
